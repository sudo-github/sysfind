...
def kinit_if_needed():
    if has_valid_tgt():
        logging.debug("Valid Kerberos TGT already exists")
        return True

    if not os.path.isfile(KEYTAB):
        logging.warning("Kerberos keytab not found: %s", KEYTAB)
        return False

    logging.info("Executing kinit using keytab: %s", KEYTAB)
    ...
    if result.returncode == 0:
        logging.info("kinit executed using keytab")
        return True
    else:
        logging.error("kinit using keytab failed")
        return False
...
def StatlistExec(debug, full, quiet, key, kconf):
    ...
    icnt = 0
    hname_full = os.uname()[1]
    hname = hname_full.split('.')[0]
    # hname = '%s' % os.uname()[1]
...
def StatlistImportin(debug):
    ...
    kconf = dict(sysstatlist=[
        ...
        {"name": "ib_rdma_link  ", "show": True, "exe": "/usr/sbin/rdma -d  link",  "chk": "/usr/sbin/dmidecode"},
        ...
        {"name": "sas3ircu-list",    "show": False, "exe": "sas3ircu list", "chk": "/root/bin/sas3ircu"},
        {"name": "sas3ircu-display", "show": False, "exe": "sas3ircu 0 display", "chk": "/root/bin/sas3ircu"},
        {"name": "sas3ircu-status" , "show": False, "exe": "sas3ircu 0 status", "chk": "/root/bin/sas3ircu"},
        ...
        {"name": "torque-pbsnode", "show": False, "exe": "/usr/local/bin/pbsnodes -a", "chk": "/usr/local/bin/pbsnodes"},
        {"name": "torque-momctl ", "show": False, "exe": "/usr/local/sbin/momctl -d 6", "chk": "/usr/local/sbin/momctl"},
        {"name": "torque-qmgr   ", "show": False, "exe": "/usr/local/bin/qmgr -c 'p s'", "chk": "/usr/local/bin/qmgr"},
        {"name": "torque-qstatq ", "show": False, "exe": "/usr/local/bin/qstat -fQ", "chk": "/usr/local/bin/qstat"},
        {"name": "torque-qstatb ", "show": False, "exe": "/usr/local/bin/qstat -fB", "chk": "/usr/local/bin/qstat"},
        {"name": "torque-svrname", "show": False, "exe": "cat /var/spool/torque/server_name",
         "chk": "/var/spool/torque/server_name"},
        {"name": "torque-momcfg ", "show": False, "exe": "cat /var/spool/torque/mom_priv/config",
        ...
        {"name": "slurmctld.log ", "show": True, "exe": "cat /var/log/slurmctld.log", "chk": "/var/log/slurmctld.log"},
        {"name": "slurmd.log    ", "show": True, "exe": "cat /var/log/slurmd.log", "chk": "/var/log/slurmd.log"},
        {"name": "slurmdbd.log  ", "show": True, "exe": "cat /var/log/slurm/slurmdbd.log", "chk": "/var/log/slurm/slurmdbd.log"},
        {"name": "slurm.conf    ", "show": True, "exe": "cat /etc/slurm/slurm.conf", "chk": "/etc/slurm/slurm.conf"},
        {"name": "slurm_cgroup.conf   ", "show": True, "exe": "cat /etc/slurm/cgroup.conf", "chk": "/etc/slurm/cgroup.conf"},
        {"name": "slurm_slurmdbd.conf ", "show": True, "exe": "cat /etc/slurm/slurmdbd.conf", "chk": "/etc/slurm/slurmdbd.conf"},
        {"name": "slurm_sinfo_Nl      ", "show": True, "exe": "/usr/bin/sinfo -N -l",    "chk": "/usr/bin/sinfo"},
        {"name": "slurm_squeue_l      ", "show": True, "exe": "/usr/bin/squeue -l",    "chk": "/usr/bin/squeue"},
        {"name": "slurm_squeue_l      ", "show": True, "exe": "/usr/bin/squeue -l",    "chk": "/usr/bin/squeue"},
        {"name": "slurm_sacctmgr_show ", "show": True, "exe": "/usr/bin/sacctmgr show cluster",    "chk": "/usr/bin/sacctmgr"},
        {"name": "slurm_sacctmgr_conf ", "show": True, "exe": "/usr/bin/sacctmgr list Configuration",    "chk": "/usr/bin/sacctmgr"},
        {"name": "slurm_sacctmgr_stats", "show": True, "exe": "/usr/bin/sacctmgr show stats",    "chk": "/usr/bin/sacctmgr"},
        ...
        {"name": "ipa_config_show"    , "show": True, "exe": "ipa config-show"             ,    "chk": "/usr/bin/ipa"},
        {"name": "ipa_dnsconfig_show" , "show": True, "exe": "ipa dnsconfig-show"          ,    "chk": "/usr/bin/ipa"},
        {"name": "ipa_user_find"      , "show": True, "exe": "ipa user-find --all"         ,    "chk": "/usr/bin/ipa"},
        {"name": "ipa_host_find"      , "show": True, "exe": "ipa host-find --all"         ,    "chk": "/usr/bin/ipa"},
        {"name": "ipa_server_find"    , "show": True, "exe": "ipa server-find --all"       ,    "chk": "/usr/bin/ipa"},
        {"name": "ipa_pwpolicy_find"  , "show": True, "exe": "ipa pwpolicy-find --all"     ,    "chk": "/usr/bin/ipa"},
        {"name": "ipa_service_find"   , "show": True, "exe": "ipa service-find --all"      ,    "chk": "/usr/bin/ipa"},
        {"name": "ipa_dnsserver_find" , "show": True, "exe": "ipa dnsserver-find --all"    ,    "chk": "/usr/bin/ipa"},
        {"name": "ipa_getcert_list"   , "show": True, "exe": "ipa-getcert list"            ,    "chk": "/usr/bin/ipa-getcert"},
        {"name": "ipa_healthcheck"    , "show": True, "exe": "ipa-healthcheck --output-type json --verbose" , "chk": "/usr/bin/ipa-healthcheck"},
        {"name": "ipa_default.conf"   , "show": True, "exe": "cat /etc/ipa/default.conf",    "chk": "/etc/ipa/default.conf"},
        {"name": "ipa_krb5.conf"      , "show": True, "exe": "cat /etc/krb5.conf",    "chk": "/etc/krb5.conf"},
        {"name": "ipa_sssd.conf"      , "show": True, "exe": "cat /etc/sssd/sssd.conf",    "chk": "/etc/sssd/sssd.conf"},
        {"name": "ipa_ipa-ext.conf"   , "show": True, "exe": "cat /etc/named/ipa-ext.conf",    "chk": "/etc/named/ipa-ext.conf"},
        {"name": "ipa_ipa-log-ext.conf", "show": True, "exe": "cat /etc/named/ipa-logging-ext.conf", "chk": "/etc/named/ipa-logging-ext.conf"},
        {"name": "ipa_ipa-opt-ext.conf", "show": True, "exe": "cat /etc/named/ipa-options-ext.conf", "chk": "/etc/named/ipa-options-ext.conf"},
        {"name": "ipa_kadmind.log"    , "show": True, "exe": "cat /var/log/kadmind.log",    "chk": "/var/log/kadmind.log"},
        {"name": "ipa_krb5kdc.log"    , "show": True, "exe": "cat /var/log/krb5kdc.log",    "chk": "/var/log/krb5kdc.log"},
        {"name": "ipa-custodia.audit.log" , "show": True, "exe": "cat /var/log/ipa-custodia.audit.log",  "chk": "/var/log/ipa-custodia.audit.log"},
        {"name": "ipaclient-install.log"  , "show": True, "exe": "cat /var/log/ipaclient-install.log",   "chk": "/var/log/ipaclient-install.log"},
        {"name": "ipaclient-uninstall.log", "show": True, "exe": "cat /var/log/ipaclient-uninstall.log", "chk": "/var/log/ipaclient-uninstall.log"},
        {"name": "ipaserver-install.log"  , "show": True, "exe": "cat /var/log/ipaserver-install.log",   "chk": "/var/log/ipaserver-install.log"},
        {"name": "ipaserver-uninstall.log", "show": True, "exe": "cat /var/log/ipaserver-uninstall.log", "chk": "/var/log/ipaserver-uninstall.log"},
        {"name": "ipa_named_capacity.log", "show": True, "exe": "cat /var/named/data/capacity.log", "chk": "/var/named/data/capacity.log"},
        {"name": "ipa_named_database.log", "show": True, "exe": "cat /var/named/data/database.log", "chk": "/var/named/data/database.log"},
        {"name": "ipa_named_dnssec.log", "show": True, "exe": "cat /var/named/data/dnssec.log", "chk": "/var/named/data/dnssec.log"},
        {"name": "ipa_named_lame-servers.log", "show": True, "exe": "cat /var/named/data/lame-servers.log", "chk": "/var/named/data/lame-servers.log"},
        {"name": "ipa_named_named.log", "show": True, "exe": "cat /var/named/data/named.log", "chk": "/var/named/data/named.log"},
        {"name": "ipa_named_query.log", "show": True, "exe": "cat /var/named/data/query.log", "chk": "/var/named/data/query.log"},
        {"name": "ipa_named_query_errors.log", "show": True, "exe": "cat /var/named/data/query_errors.log", "chk": "/var/named/data/query_errors.log"},
        {"name": "ipa_named_resolver.log", "show": True, "exe": "cat /var/named/data/resolver.log", "chk": "/var/named/data/resolver.log"},
        {"name": "ipa_named_security.log", "show": True, "exe": "cat /var/named/data/security.log", "chk": "/var/named/data/security.log"},
        {"name": "ipa_named_update.log", "show": True, "exe": "cat /var/named/data/update.log", "chk": "/var/named/data/update.log"},
        {"name": "sssd_krb5_child.log" , "show": True, "exe": "cat /var/log/sssd/krb5_child.log",    "chk": "/var/log/sssd/krb5_child.log"},
        {"name": "sssd_ldap_child.log" , "show": True, "exe": "cat /var/log/sssd/ldap_child.log",    "chk": "/var/log/sssd/ldap_child.log"},
        {"name": "sssd_sssd.log"       , "show": True, "exe": "cat /var/log/sssd/sssd.log",          "chk": "/var/log/sssd/sssd.log"},
        {"name": "sssd_ifp.log"       , "show": True, "exe": "cat /var/log/sssd/sssd_ifp.log",          "chk": "/var/log/sssd/sssd_ifp.log"},
        {"name": "sssd_kcm.log"       , "show": True, "exe": "cat /var/log/sssd/sssd_kcm.log",          "chk": "/var/log/sssd/sssd_kcm.log"},
        {"name": "sssd_nss.log"       , "show": True, "exe": "cat /var/log/sssd/sssd_nss.log",          "chk": "/var/log/sssd/sssd_nss.log"},
        {"name": "sssd_pac.log"       , "show": True, "exe": "cat /var/log/sssd/sssd_pac.log",          "chk": "/var/log/sssd/sssd_pac.log"},
        {"name": "sssd_pam.log"       , "show": True, "exe": "cat /var/log/sssd/sssd_pam.log",          "chk": "/var/log/sssd/sssd_pam.log"},
        {"name": "sssd_ssh.log"       , "show": True, "exe": "cat /var/log/sssd/sssd_ssh.log",          "chk": "/var/log/sssd/sssd_ssh.log"},
        {"name": "sssd_sudo.log"       , "show": True, "exe": "cat /var/log/sssd/sssd_sudo.log",        "chk": "/var/log/sssd/sssd_sudo.log"},
        {"name": "sssd_sssd_domain.log", "show": True, "exe": "cat /var/log/sssd/sssd_$(hostname -d).log", "chk": True },
        {"name": "ipa_slapd_access   ", "show": True, 
         "exe": "ls -1 /var/log/dirsrv/slapd-*/access 2>/dev/null | xargs -i bash -c 'echo ; echo :::EL7::: ipa_slapd_$(basename {}); cat {}'", 
         "chk": "/bin/true"},
        {"name": "ipa_slapd_errors   ", "show": True, 
         "exe": "ls -1 /var/log/dirsrv/slapd-*/errors 2>/dev/null | xargs -i bash -c 'echo ; echo :::EL7::: ipa_slapd_$(basename {}); cat {}'", 
         "chk": "/bin/true"},
        {"name": "ipa_slapd_security ", "show": True, 
         "exe": "ls -1 /var/log/dirsrv/slapd-*/security 2>/dev/null | xargs -i bash -c 'echo ; echo :::EL7::: ipa_slapd_$(basename {}); cat {}'", 
         "chk": "/bin/true"},
